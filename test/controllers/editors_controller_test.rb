...
class EditorsControllerTest < ActionController::TestCase
  ...
  test "should create editor" do
    assert_difference('Editor.count') do
      post :create, editor: { email: @editor.email, is_admin: @editor.is_admin, name: @editor.name, password: 'secret', password_confirmation: 'secret' }
    end
  ...
  test "should update editor" do
    patch :update, id: @editor, editor: { email: @editor.email, is_admin: @editor.is_admin, name: @editor.name, password: 'secret', password_confirmation: 'secret' }
    assert_redirected_to editor_path(assigns(:editor))
  end
